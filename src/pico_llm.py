...
# python pico_llm.py --block_size 32 --tinystories_weight 1.0 --prompt "The King" --device_id cuda:0
# python pico_llm.py --block_size 32 --max_steps_per_epoch 1500 --tinystories_weight 0.0 --input_files shakespeare_lines.txt --prompt "The King" --device_id cuda:0
# python pico_llm.py --block_size 32 --tinystories_weight 1.0 --input_files shakespeare_lines.txt --prompt "The King" --device_id cuda:0
...
class TransformerBlock(nn.Module):
    ...
    def forward(self, x, return_attn=False, return_activations=False):
        ...
        attn_output = self.attn(norm_x, return_attn=(return_attn or return_activations))
        ...
        # Note: No final norm here. That happens in the main model.
